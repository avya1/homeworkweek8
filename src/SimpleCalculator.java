...
public class SimpleCalculator {
    ...
    public void setFirstNumber(double firstNumber)//no return type with parameter method
    {
        this.firstNumber=firstNumber;
    }
    public void setSecondNumber(double secondNumber)//no return type with parameter method
    {
        this.secondNumber=secondNumber;
    }
    public double getAdditionResult()//with return type no parameter method
    {
        return firstNumber+secondNumber;
    }
    public double getSubtractionResult()//with return type no parameter method
    {
        return firstNumber-secondNumber;
    }
    public double getMultiplicationResult()//with return type no parameter method
    {
        return firstNumber*secondNumber;
    }
    public double getDivisionResult()//with return type no parameter method
    {
        if(secondNumber==0){
            return 0;
        }
