...
public class Point {
    ...
    Point()//nor argument constructor
    {
    ...
    public double distance()//instance method with no parameter
    {
        double x=0,y=0,d;
   ...
   public double distance(Point second )//instance method with user define data type
   {

        double d=Math.sqrt((second.x-this.x)*(second.x-this.x)+(second.y-this.y)*(second.y-this.y));
        return d;
